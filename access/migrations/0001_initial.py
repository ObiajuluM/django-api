    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(db_index=True, default=uuid.UUID('2ccddc3e-e83c-4fde-9c6c-70be0b01208a'), editable=False, unique=True, verbose_name='UUID')),
                ...
                ('is_admin', models.BooleanField(default=False, help_text='Designates whether this user can log into the admin site.', verbose_name='Admin')),
            ],
            options={
                'verbose_name': 'User',
